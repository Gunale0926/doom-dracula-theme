...
(defcustom doom-dracula-colorful-headers nil
  "If non-nil, headers in org-mode will be more colorful; which is truer to original Dracula Emacs theme."
  :group 'doom-dracula-theme
  :type 'boolean)
...
(def-doom-theme pro-dracula
  "A dark theme based on Dracula theme"

  ;; name        default   256       16
  ((bg         '("#0B0D0F" "#262626" "black"        ))
   (bg-alt     '("#0B0D0F" "#1c1c1c" "black"        ))
   ...
   (grey       base4)
   (red        '("#FF9580" "#ff6655" "red"          ))
   (orange     '("#FFCA80" "#ffbb66" "brightred"    ))
   (green      '("#8AFF80" "#55ff77" "green"        ))
   (teal       '("#0189cc" "#0088cc" "brightgreen"  ))
   (yellow     '("#FFFF80" "#ffff88" "yellow"       ))
   (blue       '("#61bfff" "#66bbff" "brightblue"   ))
   (dark-blue  '("#414D58" "#0088cc" "blue"         ))
   (magenta    '("#FF80BF" "#ff77cc" "magenta"      ))
   (violet     '("#bd93f9" "#bb99ff" "brightmagenta"))
   (cyan       '("#80FFEA" "#88eeff" "brightcyan"   ))
   (dark-cyan  '("#708CA9" "#88eeff" "cyan"         ))
   ...
   (type           cyan)
   (strings        yellow)
   (variables      (doom-lighten magenta 1))
   (numbers        violet)
